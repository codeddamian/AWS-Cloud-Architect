...
# Configure iam role
resource "aws_iam_role" "iam_lambda_role_1" {
...
resource "aws_iam_policy" "lambda_log_policy_1" {
...
resource "aws_iam_role_policy_attachment" "lambda_log_policy" {
  role       = aws_iam_role.iam_lambda_role_1.name
  policy_arn = aws_iam_policy.lambda_log_policy_1.arn
}
...
resource "aws_lambda_function" "hello_world_lambda" {
  ...
  runtime = "python3.8"
  role = aws_iam_role.iam_lambda_role_1.arn
